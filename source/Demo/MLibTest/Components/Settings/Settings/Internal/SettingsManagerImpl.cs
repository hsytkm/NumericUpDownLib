...
internal class SettingsManagerImpl : ISettingsManager
{
    ...
    /// </summary>
    public IEngine? Options => mSettingsDataPanel?.Options;
    ...
    /// </summary>
    [XmlIgnore]
    public int DefaultFixedFontSize => 12;
