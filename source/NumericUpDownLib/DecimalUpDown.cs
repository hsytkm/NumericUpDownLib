...
public partial class DecimalUpDown : AbstractBaseUpDown<decimal>
{
    ...
    {
        get => (decimal)GetValue(LargeStepSizeProperty);
    ...
    {
        if (decimal.TryParse(text, NumberStyle, CultureInfo.CurrentCulture, out decimal number))
        {
            tempValue = number;
    ...
    {
        return decimal.TryParse(text, NumberStyle, CultureInfo.CurrentCulture, out number);
    }
