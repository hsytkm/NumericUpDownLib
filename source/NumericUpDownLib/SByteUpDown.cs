...
public partial class SByteUpDown : AbstractBaseUpDown<sbyte>
{
    ...
    {
        get => (sbyte)GetValue(StepSizeProperty);
    ...
    {
        get => (sbyte)GetValue(LargeStepSizeProperty);
    ...
    {
        if (sbyte.TryParse(text, NumberStyle, CultureInfo.CurrentCulture, out sbyte number))
        {
            tempValue = number;
    ...
    {
        return sbyte.TryParse(text, NumberStyle, CultureInfo.CurrentCulture, out number);
    }
