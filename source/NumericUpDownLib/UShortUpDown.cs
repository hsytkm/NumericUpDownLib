...
public partial class UShortUpDown : AbstractBaseUpDown<ushort>
{
    ...
    {
        get => (ushort)GetValue(StepSizeProperty);
    ...
    {
        get => (ushort)GetValue(LargeStepSizeProperty);
    ...
    {
        if (ushort.TryParse(text, NumberStyle, CultureInfo.CurrentCulture, out ushort number))
        {
            tempValue = number;
    ...
    {
        return ushort.TryParse(text, NumberStyle, CultureInfo.CurrentCulture, out number);
    }
