...
public partial class ULongUpDown : AbstractBaseUpDown<ulong>
{
    ...
    {
        get => (ulong)GetValue(StepSizeProperty);
    ...
    {
        get => (ulong)GetValue(LargeStepSizeProperty);
    ...
    {
        if (ulong.TryParse(text, NumberStyle, CultureInfo.CurrentCulture, out ulong number))
        {
            tempValue = number;
    ...
    {
        return ulong.TryParse(text, NumberStyle, CultureInfo.CurrentCulture, out number);
    }
