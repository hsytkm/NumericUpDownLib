...
public partial class ShortUpDown : AbstractBaseUpDown<short>
{
    ...
    {
        get => (short)GetValue(StepSizeProperty);
    ...
    {
        get => (short)GetValue(LargeStepSizeProperty);
    ...
    {
        if (short.TryParse(text, NumberStyle, CultureInfo.CurrentCulture, out short number))
        {
            tempValue = number;
    ...
    {
        return short.TryParse(text, NumberStyle, CultureInfo.CurrentCulture, out number);
    }
