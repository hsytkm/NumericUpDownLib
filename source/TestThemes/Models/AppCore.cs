...
public class AppCore
{
    ...
    internal static string AssemblyEntryLocation => System.IO.Path.GetDirectoryName(Assembly.GetEntryAssembly().Location);
    ...
    public static string Company => "TestThemes";
    public static string Application_Title => "TestThemes";
    ...
    /// </summary>
    public static string DirFileAppSessionData => System.IO.Path.Combine(DirAppData,
